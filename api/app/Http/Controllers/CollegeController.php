...
class CollegeController extends Controller
{
    ...
    public function show($id)
    {
        try {
            ...
            return $this->notFound('College not found');
        }
    }
    ...
    #[OA\RequestBody(
        required: true,
        content: new OA\JsonContent(ref: "#/components/schemas/College")
    )]
    #[OA\Response(
        response: 200,
    ...
    public function store(Request $request)
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'college_shortname' => 'required|string|max:255',
