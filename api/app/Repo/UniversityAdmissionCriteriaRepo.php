...
class UniversityAdmissionCriteriaRepo extends GenericRepo implements IUniversityAdmissionCriteriaRepo
{
    public function __construct()
    {
        parent::__construct(UniversityAdmissionCriteria::class);
    }
