...
use App\Models\GradeBookItemDetail;

class GradeBookItemDetailRepo extends GenericRepo implements IGradeBookItemDetailRepo
{
    public function __construct()
    {
        parent::__construct(GradeBookItemDetail::class);
    }
