...
use App\Models\GradeBookGradingPeriod;

class GradeBookGradingPeriodRepo extends GenericRepo implements IGradeBookGradingPeriodRepo
{
    public function __construct()
    {
        parent::__construct(GradeBookGradingPeriod::class);
    }
