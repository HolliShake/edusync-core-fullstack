...
use App\Models\GradingPeriodGrade;

class GradingPeriodGradeRepo extends GenericRepo implements IGradingPeriodGradeRepo
{
    public function __construct()
    {
        parent::__construct(GradingPeriodGrade::class);
    }
