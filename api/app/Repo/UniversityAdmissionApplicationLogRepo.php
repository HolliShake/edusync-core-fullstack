...
class UniversityAdmissionApplicationLogRepo extends GenericRepo implements IUniversityAdmissionApplicationLogRepo
{
    public function __construct()
    {
        parent::__construct(UniversityAdmissionApplicationLog::class);
    }
