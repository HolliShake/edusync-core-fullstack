...
class EnrollmentService extends GenericService implements IEnrollmentService
{
    ...
    public function getEnrollmentsByAcademicProgramId(int $academicProgramId, ?string $latestStatus, int $schoolYearId, int $yearId, int $termId, int $page = 1, int $rows = 10): LengthAwarePaginator
    {
