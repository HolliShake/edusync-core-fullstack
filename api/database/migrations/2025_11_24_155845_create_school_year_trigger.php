        ...
        DB::unprepared("
            ...
            BEGIN
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_SUB(base_date, INTERVAL 1 DAY), end_date), GREATEST(DATE_SUB(base_date, INTERVAL 14 DAY), begin_date)),
                    NEW.id,
                    'ENROLLMENT',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(base_date, end_date), GREATEST(base_date, begin_date)),
                    NEW.id,
                    'ACADEMIC_TRANSITION',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(base_date, begin_date),
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 13 DAY), end_date), GREATEST(base_date, begin_date)),
                    NEW.id,
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 34 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 28 DAY), begin_date)),
                    NEW.id,
                    'PERIODIC_EXAM',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 35 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 35 DAY), begin_date)),
                    NEW.id,
                    'GRADE_SUBMISSION',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 62 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 56 DAY), begin_date)),
                    NEW.id,
                    'PERIODIC_EXAM',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 63 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 63 DAY), begin_date)),
                    NEW.id,
                    'GRADE_SUBMISSION',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 106 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 100 DAY), begin_date)),
                    NEW.id,
                    'PERIODIC_EXAM',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 113 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 107 DAY), begin_date)),
                    NEW.id,
                    'FACULTY_EVALUATION',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 139 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 139 DAY), begin_date)),
                    NEW.id,
                    'END_OF_CLASSES',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 154 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 140 DAY), begin_date)),
                    NEW.id,
                    'HOLIDAY',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 155 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 155 DAY), begin_date)),
                    NEW.id,
                    'GRADE_SUBMISSION',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 168 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 156 DAY), begin_date)),
                    NEW.id,
                    'ENROLLMENT',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 169 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 169 DAY), begin_date)),
                    NEW.id,
                    'ACADEMIC_TRANSITION',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    'Adding/Dropping period - requires adviser approval',
                    GREATEST(DATE_ADD(base_date, INTERVAL 169 DAY), begin_date),
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 182 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 169 DAY), begin_date)),
                    NEW.id,
                    'ADDING_DROPPING_OF_SUBJECTS',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 203 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 197 DAY), begin_date)),
                    NEW.id,
                    'PERIODIC_EXAM',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 204 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 204 DAY), begin_date)),
                    NEW.id,
                    'GRADE_SUBMISSION',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 231 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 225 DAY), begin_date)),
                    NEW.id,
                    'HOLIDAY',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 259 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 253 DAY), begin_date)),
                    NEW.id,
                    'PERIODIC_EXAM',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 260 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 260 DAY), begin_date)),
                    NEW.id,
                    'GRADE_SUBMISSION',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 287 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 281 DAY), begin_date)),
                    NEW.id,
                    'PERIODIC_EXAM',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 294 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 288 DAY), begin_date)),
                    NEW.id,
                    'FACULTY_EVALUATION',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 295 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 295 DAY), begin_date)),
                    NEW.id,
                    'END_OF_CLASSES',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 296 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 296 DAY), begin_date)),
                    NEW.id,
                    'GRADE_SUBMISSION',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 297 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 297 DAY), begin_date)),
                    NEW.id,
                    'GRADUATION',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 310 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 298 DAY), begin_date)),
                    NEW.id,
                    'ENROLLMENT',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 311 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 311 DAY), begin_date)),
                    NEW.id,
                    'ACADEMIC_TRANSITION',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(DATE_ADD(base_date, INTERVAL 311 DAY), begin_date),
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 338 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 311 DAY), begin_date)),
                    NEW.id,
                    'START_OF_CLASSES',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(DATE_ADD(base_date, INTERVAL 311 DAY), begin_date),
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 317 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 311 DAY), begin_date)),
                    NEW.id,
                    'ADDING_DROPPING_OF_SUBJECTS',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 338 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 338 DAY), begin_date)),
                    NEW.id,
                    'END_OF_CLASSES',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 345 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 339 DAY), begin_date)),
                    NEW.id,
                    'PERIODIC_EXAM',
                    idx,
                    NOW(),
                ...
                VALUES (
                    ...
                    GREATEST(LEAST(DATE_ADD(base_date, INTERVAL 346 DAY), end_date), GREATEST(DATE_ADD(base_date, INTERVAL 346 DAY), begin_date)),
                    NEW.id,
                    'GRADE_SUBMISSION',
                    idx,
                    NOW(),
